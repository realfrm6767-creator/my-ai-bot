...
TRANSLATIONS = {
    "fa": {
        ...
        "btn_back": "بازگشت",
        "panel_intro": "به پنل مدیریت گابیمارو خوش اومدی ↓ از اینجا می‌تونی به بخش‌های مختلف ربات دسترسی داشته باشی و یکی از گزینه‌های زیر رو انتخاب کنی:",
    ...
    "en": {
        ...
        "btn_back": "Back",
        "panel_intro": "Welcome to the Gabimaru control panel ↓ From here you can access different sections of the bot — pick an option below:",
    ...
    "ar": {
        ...
        "btn_back": "رجوع",
        "panel_intro": "مرحبًا بك في لوحة تحكم غابيمارو ↓ من هنا يمكنك الوصول إلى أقسام مختلفة من البوت، اختر أحد الخيارات أدناه:",
    ...
    "ru": {
        ...
        "btn_back": "Назад",
        "panel_intro": "Добро пожаловать в панель управления Gabimaru ↓ Отсюда можно перейти в разные разделы бота — выбери один из вариантов ниже:",
