...
TRANSLATIONS = {
    "fa": {
        ...
        "btn_leaderboard": "🏆 لیدربورد", "btn_status": "📈 وضعیت ربات",
        "btn_back": "بازگشت",
        "panel_intro": "به پنل مدیریت گابیمارو خوش اومدی 👋\nاز اینجا می‌تونی به بخش‌های مختلف ربات دسترسی داشته باشی، آمار و لیدربورد گروه رو ببینی، تنظیمات رو تغییر بدی و خیلی چیزای دیگه. یکی از گزینه‌های زیر رو انتخاب کن:",
    ...
    "en": {
        ...
        "btn_leaderboard": "🏆 Leaderboard", "btn_status": "📈 Bot Status",
        "btn_back": "Back",
        "panel_intro": "Welcome to the Gabimaru control panel 👋\nFrom here you can access different sections of the bot, check group stats and the leaderboard, change settings, and much more. Pick an option below:",
    ...
    "ar": {
        ...
        "btn_leaderboard": "🏆 المتصدرون", "btn_status": "📈 حالة البوت",
        "btn_back": "رجوع",
        "panel_intro": "مرحبًا بك في لوحة تحكم غابيمارو 👋\nمن هنا يمكنك الوصول إلى أقسام مختلفة من البوت، ومشاهدة إحصائيات وترتيب المجموعة، وتغيير الإعدادات، وغير ذلك الكثير. اختر أحد الخيارات أدناه:",
    ...
    "ru": {
        ...
        "btn_leaderboard": "🏆 Лидерборд", "btn_status": "📈 Статус бота",
        "btn_back": "Назад",
        "panel_intro": "Добро пожаловать в панель управления Gabimaru 👋\nЗдесь можно перейти в разные разделы бота, посмотреть статистику и лидерборд группы, изменить настройки и многое другое. Выбери один из вариантов ниже:",
